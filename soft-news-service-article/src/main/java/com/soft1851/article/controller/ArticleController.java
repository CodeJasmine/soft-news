...
public class ArticleController extends BaseController implements ArticleControllerApi {
    ...
    @Override
    public GraceResult createArticel(@Valid NewArticleBO newArticleBO, BindingResult result) {
        ...
        }else if (newArticleBO.getArticleType().equals(ArticleCoverType.WPRDS.type)){
    ...
    public GraceResult doReview(String articleId, Integer passOrNot) {
        ...
        if (passOrNot == YesOrNo.YES.type){
            ...
            pendingStatus= ArticleReviewStatus.FAILED_.type;
        }else {
